...
import tranzmeoInternImg from "@/assets/tranzmeo-intern-project.png";
...
const ProjectsSection = () => {
  const projects = [
    ...
    {
      title: "🤖 Agentic AI-Powered Multilingual Conversational Chatbot",
      description:
        "Built an AI-driven WhatsApp chatbot using n8n and Google Gemini that understands and responds in multiple languages, including English, Arabic, and Spanish, while remembering conversation context across messages. Designed the complete workflow architecture from message triggering and AI processing to automated response delivery, using session-based memory to keep conversations coherent and personalized.",
      image: tranzmeoInternImg,
      tags: [
        "n8n",
        "Google Gemini",
        "LLM",
      ...
      github: "https://github.com/Fouzannaseer7/Tranzmeo-Intern",
    },
  ];
